...
CREATE TABLE `products` (
  ...
  `products_unitprice` int NOT NULL,
  `quantity_available` int NOT NULL,
  PRIMARY KEY (`products_id`),
  KEY `category_id_idx` (`quantity_available`)
...
INSERT INTO `products` VALUES (1,'j',4,656),(2,'h',445,67);
...
-- Dump completed on 2023-06-04 17:10:49
